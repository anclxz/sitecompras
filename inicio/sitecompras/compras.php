...
<div class="xain">
    ...
    <table class="principal">
        ...
        <tr>
            ...
            <td><input type="text" name="vl0" value="R$ 75,00" readonly></td>
        </tr>
        <tr>
            ...
            <td><input type="text" name="vl1" value="R$ 50,00" readonly></td>
        </tr>
        <tr>
            ...
            <td><input type="text" name="vl2" value="R$ 399,00" readonly></td>
        </tr>
        <tr>
            ...
            <td><input type="text" name="vl3" value="R$ 100,00" readonly></td>
        </tr>
        <tr>
            ...
            <td><input type="text" name="vl4" value="R$ 20,00" readonly></td>
        </tr>
        <tr>
            ...
            <td><input type="text" name="vl5" value="R$ 35,00" readonly></td>
        </tr>
        <tr>
            ...
            <td><input type="text" name="vl6" value="R$ 85,00" readonly></td>
        </tr>
        <tr>
            ...
            <td><input type="text" name="vl7" value="R$ 50,00" readonly></td>
        </tr>
        <tr>
            ...
            <td><input type="text" name="vl8" value="R$ 39,00" readonly></td>
        </tr>
        <tr>
            ...
            <td><input type="text" name="vl9" value="R$ 95,00" readonly></td>
        </tr>
        <tr>
            <td colspan="5">
